                                        ...
                                        <div class="col-lg-12">
                                            <form action="{{ route('supplier.store') }}" method="POST" role="form" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    <label class="mb-2 mt-3 mx-2 text-dark">Nama Supplier</label>
                                                    <input type="text" class="form-control" name="nama_supplier" placeholder="Nama Supplier">
                                                </div>
                                                <div class="form-group">
                                                    <label class="mb-2 mt-3 mx-2 text-dark">Alamat</label>
                                                    <input type="text" class="form-control" name="alamat" placeholder="Alamat">
                                                </div>
                                                <div class="form-group">
                                                    <label class="mb-2 mt-3 mx-2 text-dark">Nama Brand</label>
                                                    <input type="text" class="form-control mb-4" name="nama brand" placeholder="Nama Brand">
                                                </div>
