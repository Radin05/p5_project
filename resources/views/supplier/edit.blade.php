                                        ...
                                        <div class="col-lg-12">
                                            <form action="{{ route('supplier.update', $supplier->id) }}" method="POST" role="form" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control mb-3" name="nama brand" value="{{ $supplier->nama_brand }}" placeholder="Nama Brand">
                                                </div>
                                                <a href="{{route('supplier.index')}}"class="btn-secondary btn btn-default">Kembali</a>
                                                <button type="submit" class="btn-success btn btn-default">Edit</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
